...
namespace DnD4e.CharacterOOP
{
    public class Character : INotifyPropertyChanged
    {
        ...
        public Character(JSONConverter buffer)
        {
            ...
            Class = new Classes(buffer._class_class, buffer._class_subclasses);
        ...
        public CharacterBuffer SaveCharacter()
        {
            ...
            buffer.Size = Size;
            buffer.Speed = Speed;
            buffer.Initiative = Initiative;
            buffer.PassiveInsight = PassiveInsight;
            buffer.PassivePerception = PassivePerception;
            buffer.MaxAP = MaxAP;
        ...
        public JSONConverter SaveCharacter(int i)
        {
