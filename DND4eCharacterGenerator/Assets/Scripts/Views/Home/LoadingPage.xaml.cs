    ...
    public partial class LoadingPage : Window
    {
        ...
        private void worker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            for (int i = 2; i < (itemCounts[x] + 2); i++)
            {
                ...
                tempChoice1.OptionsBenefits = mySubclassData[56].Split('|').ToList();
                tempChoice1.OptionBenefitTypes = mySubclassData[57].Split('|').ToList();
                ...
                tempChoice2.OptionType = mySubclassData[61];
                tempChoice2.OptionsBenefits = mySubclassData[62].Split('|').ToList();
                tempChoice2.OptionBenefitTypes = mySubclassData[63].Split('|').ToList();
